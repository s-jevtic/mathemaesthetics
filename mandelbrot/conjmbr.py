...
print("Initializing conjugate Mandelbrot set creator...")
...
def mandelbrot(field, it):
    print("Initializing conjugate Mandelbrot algorithm...")
...
np.save("./outfiles/mbconj_i{0}_n{1}".format(it, lsnum), mb)
